...
imm|add|adc|sub|sbb|and|or|xor|sla|slx|sl0|sl1|rl|sra|srx|sr0|sr1|rr|cmp|test|load|mul|muls|div|divs|bsl|bsr|fmul|fdiv|fadd|fsub|fcmp|fint|fflt|nop|sleep|jump|jumpz|jumpc|jumpnz|jumpnc|call|callz|callc|callnz|callnc|svc|ret|reti|rete|ldw|stw|ldspr|stspr|out|in { yylval.sval = strdup(yytext); return OPCODE; }
